Famous.loaded(function (require) {
    ...
    var o = (require("famous/Engine"), require("famous/Surface")),
        ...
        h = require("famous-sync/GenericSync"),
        u = require("famous/Transitionable"),
        p = require("famous-physics/utils/SpringTransition"),
        c = (require("famous-views/Scrollview"), require("famous/ContainerSurface"), require("famous/Utility")),
        l = require("famous-utils/Utils"),
        f = Paper.ProfilePicsView,
        d = Paper.NameView,
        m = Paper.TextView,
        y = Paper.ArticleView,
        v = Paper.FooterView;
